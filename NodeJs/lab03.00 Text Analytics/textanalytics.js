...
request({
  ...
  uri:'https://southeastasia.api.cognitive.microsoft.com/text/analytics/v2.0/sentiment',
  body:temp,
  method: 'POST'
...
var temp=JSON.stringify(data);
  ...
  uri:'https://southeastasia.api.cognitive.microsoft.com/text/analytics/v2.0/keyPhrases',
  body:temp,
  method: 'POST'
}, function (err, res, body) {
  if (err) {
...
var temp=JSON.stringify(data);
  ...
  uri:'https://southeastasia.api.cognitive.microsoft.com/text/analytics/v2.0/entities',
  body:temp,
  method: 'POST'
}, function (err, res, body) {
  if (err) {
...
var temp=JSON.stringify(data);
  ...
  uri:'https://southeastasia.api.cognitive.microsoft.com/text/analytics/v2.0/languages',
  body:temp,
  method: 'POST'
}, function (err, res, body) {
  if (err) {
