...
namespace MicrosoftSpeechSDKSamples
{
    public class SpeechRecognitionSamples
    {
        ...
        public static async Task RecognitionWithMicrophoneAsync()
        {
            ...
            var config = SpeechConfig.FromSubscription("179169795bbb4775804f768f6f0ade6c", "southeastasia");
        ...
        public static async Task RecognitionUsingCustomizedModelAsync()
        {
            ...
            // Creates an instance of a speech config with specified subscription key and service region.
            // Replace with your own subscription key and service region (e.g., "westus").
            var config = SpeechConfig.FromSubscription("1b08bc65feeb45ee821f6dcb8ac72db7", "westus");
            // Replace with the CRIS endpoint id of your customized model.
            config.EndpointId = "aea6d5aa-56aa-49da-8ed6-02e115e9ab8e";
